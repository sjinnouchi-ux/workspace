...
- focused contract test `python codex/tests/test_shogun_ops_docs.py`（7 tests）と既存intake contract test `python codex/tests/test_shogun_task_intake_docs.py`、`git diff --check` を実行する。full suiteは実行しない。
