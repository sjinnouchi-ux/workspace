...
|---|---|---|---|---|---|---|---|
| 税理士事務所DX | 税理士DX, zeirishi-office-dx | Active / Planning | 未定 | 未定 | `https://github.com/sjinnouchi-ux/zeirishi-office-dx` | `AGENTS.md`; `README.md`; `PROJECT_BRIEF.md`; `docs/secret-management.md`; `IMPLEMENTATION_LOG.md` | `yumekango.com` ではない別Googleアカウントを使用する。アカウントは確認済みで、識別子はprivate repoの `docs/secret-management.md` を正本とする。GCP projectは未確定、Secret Managerは未構築。要件、対象業務、技術構成、設計・実装担当は未確定。 |
