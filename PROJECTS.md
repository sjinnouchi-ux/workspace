...
| 管理ターミナル | management-terminal, mgmt-terminal, コアDB, コアAI, コアプラットフォーム | Active / Parent | Claude / Codex | Codex | `https://github.com/sjinnouchi-ux/mgmt-terminal` | `docs/superpowers/specs/2026-07-19-management-terminal-core-db-ai-charter.md`; `docs/DATABASE_SCHEMA.md`; `docs/superpowers/specs/2026-07-15-finance-foundation-design.md`; `docs/superpowers/plans/2026-07-15-finance-foundation-roadmap.md`; `docs/reports/2026-07-15-finance-core-implementation-log.md` | 管理ターミナルにコアDBを実装し、既存の管理情報を整理する親プロジェクト。将来の子プロジェクトはコア基盤の構築単位であり、既存事業repoを自動的に子扱いしない。Migration 1のlinked Supabase適用状態は実装ログを正本とし、Migration 2AまではHTTP/API権限を変更しない。 |
